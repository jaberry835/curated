export const environment = {
  ...
  azure: {
    ...
    redirectUri: 'https://rudechat.azurewebsites.us',
    openai: {
    ...
    functions: {
      ...
      mcpServerUrl: 'https://rudechat.azurewebsites.us/api/mcp' // Points to same app service
    }
  },
  api: {
    baseUrl: 'https://rudechat.azurewebsites.us/api' // Same app service API endpoints
  }
};
