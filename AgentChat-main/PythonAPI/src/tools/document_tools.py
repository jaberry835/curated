...
async def get_document_metadata_impl(document_id: str, user_id: str = None):
...
async def get_document_content_summary_impl(document_id: str, user_id: str = None, max_length: int = 500):
