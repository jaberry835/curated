...
def ask_agents():
    ...
    try:
        ...
        try:
            ...
            response = loop.run_until_complete(agent_system.process_question(question, session_id))
...
def chat_completions():
    ...
    try:
        ...
        try:
            ...
            # Run agent processing with both user_id and session_id
            agent_response = loop.run_until_complete(agent_system.process_question(user_question, session_id, user_id))
