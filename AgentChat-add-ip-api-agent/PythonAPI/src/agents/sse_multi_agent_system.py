...
class SSEMultiAgentSystem:
    ...
    def __init__(self, azure_endpoint: str, azure_api_key: str, azure_deployment: str, mcp_server_url: str):
        ...
        self._current_adx_token: Optional[str] = None
    ...
    def set_adx_token(self, adx_token: str):
        """Set the ADX access token for user impersonation."""
        self._current_adx_token = adx_token
        # Update the MCP client with the new token
    ...
    async def process_question(self, question: str, session_id: Optional[str] = None, user_id: Optional[str] = None, adx_token: Optional[str] = None) -> str:
        ...
        try:
            ...
            result = await self.agent_system.process_question(question, session_id, user_id, adx_token)
